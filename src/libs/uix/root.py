...
from libs.uix.baseclass.widgets import BottomBar

Builder.load_file('libs/uix/kv/widgets.kv')
...
class Root(BoxLayout):
    ...
    def push(self, screen_name):
        return self.sm.push(screen_name)

    def push_replacement(self, screen_name, side="left"):
        return self.sm.push_replacement(screen_name, side)
